    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('help_text', models.TextField(blank=True, help_text='Help text for the field. Markdown syntax is permitted.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('field_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='jasmin_metadata.Field')),
                ('choices', models.ManyToManyField(to='jasmin_metadata.UserChoice')),
            ],
            options={
                'abstract': False,
